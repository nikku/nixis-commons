...
/**
 * Decorator filter for Sitemesh 3 which initializes sitemesh to use
 * the {@link NonAjaxRequestDecoratorSelector}.
 *
 * The layout used by this decorator may be specified via the
 * `de.nixis.commons.sitemesh-decorator.layout` init parameter for this filter. 
 * It defaults to `/WEB-INF/views/layout.jsp`.
 *
...
public class SiteMeshDecoratorFilter extends ConfigurableSiteMeshFilter {
    ...
    /**
     * Plugs in the ajax functionality. The behaviour may be configured in
     * subclasses of this filter.
     *
     * @see SiteMeshDecoratorFilter#registerDecoratorPaths(org.sitemesh.builder.SiteMeshFilterBuilder)
     * @see SiteMeshDecoratorFilter#registerDecoratorSelectors(org.sitemesh.builder.SiteMeshFilterBuilder)
     * @see SiteMeshDecoratorFilter#setMimeTypes(org.sitemesh.builder.SiteMeshFilterBuilder)
    ...
    /**
     * Register decorator paths for the application by specifying layout files
     * for one or more url patterns.
     *
     * The default behaviour is to register the default layout
     * (see {@link SiteMeshDecoratorFilter}) on all paths (`/*`). 
     *
     * @param builder the builder to apply the configuration to
     */
     ...
     *
     * The default behaviour is to regiter the text/html mime type to be
     * intercepted by sitemesh.
     *
     * @param builder the builder to apply the configuration to
     */
