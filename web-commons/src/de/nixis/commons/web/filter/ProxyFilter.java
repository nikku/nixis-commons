 ...
 * @author Muffelbox
 */
public class ProxyFilter extends GenericClass implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException { 
        ...
        if (wrapper.shouldBeDispatched()) wrapper.dispatchToRealDestination(response);
        else chain.doFilter(wrapper, response);
    }
